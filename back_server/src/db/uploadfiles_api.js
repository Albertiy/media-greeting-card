...
const addMultipleSql = 'insert into uploadfiles(uuid, record_id, product_id) values ?';
 ...
 * @returns 
 */
function addMultiple(codes, recordId, productId = null) {
    let values = [];
    codes.forEach(element => {
        values.push([element, recordId, productId]);
    });
