        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.audio_block}>
                    <audio className={styles.audio} ref={audioEle} controls={true} style={showAudio ? {} : { display: 'none' }} playsInline={true} webkit-playsinline="true" muted={recordBtnState == RecordBtnStateEnum.STOP}></audio>
                </div>
